        ...
        <div class="modal-content bg-white shadow-2xl rounded-xl">
            ...
            <form action="{{ route('data_tpk.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="no_sk_desa" class="block text-sm font-medium text-gray-700">NO SK Kades</label>
                            <input type="text" name="no_sk_desa" placeholder="Masukkan no_sk_desa"
                                class="mt-2 block w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                        </div>

                        <div>
                            <label for="tanggal_sk_desa" class="block text-sm font-medium text-gray-700">Tanggal SK Kades</label>
                            <input type="date" name="tanggal_sk_desa" placeholder="Masukkan tanggal_sk_desa"
                                class="mt-2 block w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                        </div>
